...
const LoginPage = () => {
    ...
    useEffect(() => {
        console.log("triggered:", session, status, redirected);
        ...
        // Ensure the session is authenticated and redirect has not occurred yet
        if (session && status === "authenticated" && !redirected) {
          ...
          setRedirected(true); // Mark as redirected to prevent further toasts
            ...
            <main className="flex-grow p-4">
                <div className="max-w-sm mx-auto p-6 rounded-lg shadow-lg border border-base-300">
                    ...
                    <p className="text-center mt-4">
                        Don&apos;t have an account? <Link href="/Account/SignUp" className="text-blue-500 hover:underline">Sign up here</Link>
                    </p>
                </div>
            </main>
