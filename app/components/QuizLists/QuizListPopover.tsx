...
const QuizListPopover: React.FC<QuizModalProps> = ({ quizTitle, onClose }) => {
    return (
      ...
      <div className="bg-cardBackground p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <button
          className="px-4 py-2 mr-4 bg-blue-500 text-white rounded-md font-medium hover:bg-blue-700 transition"
          onClick={onClose}
        >
            Confirm Deletion
        </button>
        ...
        <button
          className="px-4 py-2 mt-2 bg-error text-white rounded-md font-medium hover:bg-red-700 transition"
          onClick={onClose}
        >
          Close
        </button>
