...
export default function FeedbackPage() {
    return (
        <main className="flex flex-col min-h-screen items-center bg-background text-white p-6">
            ...
            <p className="text-bodyText ">Your Feedback is valuable for this site and also for this Dissertation Project. Please share your thoughts with us through this Link to the Form
